...
public class TitleAndLogoValidation extends CommonMethods{
	...
	/*   commenting them out since we made the setUp() sand tearDown() beforeMethod and AfterMethod
	...
	*/
	...
	public void titleValidation() throws Exception
	{
		...
		else 
		{
			...
			throw new Exception(); //later on we will use Assertions                 //THIS IS A GENERAL EXCEPTION. IN THE FUTURE BY USING ASSERTIONS WE WILL HAVE SPECIFIC EXCEPTIONS!!!
